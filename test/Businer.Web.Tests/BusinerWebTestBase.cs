...
{
    public abstract class BusinerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BusinerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BusinerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BusinerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BusinerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BusinerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BusinerDbContext, Task<T>> func)
        {
            T result;
